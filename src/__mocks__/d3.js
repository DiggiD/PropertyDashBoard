...
const createTransition = () => {
  const transition = {
    duration: function() { return transition; },
    ease: function() { return transition; },
    delay: function() { return transition; },
    style: function() { return transition; },
    attr: function() { return transition; },
    remove: function() { return transition; },
    call: function() { return transition; },
    on: function() { return transition; },
    attrTween: function() { return transition; },
    selectAll: function() { return transition; },
    select: function() { return transition; },
    each: function() { return transition; }
  };
  return transition;
};
...
const createSelection = () => {
  ...
  const selection = {
    ...
    style: function() { return selection; },
    classed: function() { return selection; },
    on: function() { return selection; },
    transition: function() { return createTransition(); },
    duration: function() { return selection; },
    ease: function() { return selection; },
    delay: function() { return selection; },
    remove: function() { return selection; },
    call: function() { return selection; },
    node: function() { return selection; },
    width: function() { return selection; },
    height: function() { return selection; },
    select: function() { return createSelection(); },
    selectAll: function() { return createSelection(); },
    data: function() { return createSelection(); },
    enter: function() { return createSelection(); },
    each: function() { return selection; },
    attrTween: function() { return selection; },
    empty: function() { return selection; },
    outerHTML: '<svg></svg>',
    html: function() { return selection; }
  };
  return selection;
};
